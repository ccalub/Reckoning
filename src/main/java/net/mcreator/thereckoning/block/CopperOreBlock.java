...
public class CopperOreBlock extends ThereckoningModElements.ModElement {
	@ObjectHolder("thereckoning:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(ThereckoningModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("thereckoning:copper_ore_match"), () -> CustomRuleTest.codec);
