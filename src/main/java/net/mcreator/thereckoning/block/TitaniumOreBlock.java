...
public class TitaniumOreBlock extends ThereckoningModElements.ModElement {
	@ObjectHolder("thereckoning:titanium_ore")
	public static final Block block = null;
	public TitaniumOreBlock(ThereckoningModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("thereckoning:titanium_ore_match"), () -> CustomRuleTest.codec);
